...
import { poolPingDirect } from "./pool-ping-direct.js";
...
export function registerJobs(worker: BackgroundWorker): void {
  worker
    ...
    .schedule(POOL_PING_DIRECT_JOB, THIRTY_SECONDS_MS, poolPingDirect)  
    .schedule(POOL_PING_JOB, THIRTY_MINUTES_MS, poolPing)            
